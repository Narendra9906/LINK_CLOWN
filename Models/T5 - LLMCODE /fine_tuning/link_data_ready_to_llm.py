...
train_df = pd.read_csv('/home/amit/final_all/train.csv')
test_df = pd.read_csv('/home/amit/final_all/test.csv')
...
def preprocess_function(sample, padding="max_length"):
    ...
    inputs = [prompt_instruction + item for item in sample["question"]]
...
tokenized_dataset["train"].save_to_disk("/home/amit/link_2/train")
tokenized_dataset["test"].save_to_disk("/home/amit/link_2/eval")
